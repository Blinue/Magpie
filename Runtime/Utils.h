...
public:
    ...
    static void SaveD2DImage(
        ...
        Debug::ThrowIfFailed(frameEncoder->Commit(), L"IWICBitmapFrameEncode.Commit 失败");
        Debug::ThrowIfFailed(bmpEncoder->Commit(), L"IWICBitmapEncoder.Commit 失败");
        Debug::ThrowIfFailed(stream->Commit(STGC_DEFAULT), L"IStream.Commit 失败");
    }
};
