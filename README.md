...
3. 为窗口创建配置文件：这使你可以保存针对某个窗口的配置。如果开启了“位于前台时自动缩放”，切换到该窗口时，Magpie 会自动执行缩放。
...
<img src="img/主窗口.png" alt= "Main window" height="250">
...
1. 如果你设置了 DPI 缩放，而要放大的窗口没有高 DPI 支持（这在老游戏中很常见），推荐首先进入该程序的兼容性设置，将“高 DPI 缩放替代”设置为“应用程序”。
   ...
   <p align="center">
      <img src="img/高DPI设置.png" alt= "高 DPI 设置" width="600" />
   </p>
