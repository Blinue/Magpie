...
const DependencyProperty KeyVisual::ContentProperty = DependencyProperty::Register(
	...
	xaml_typename<Magpie::UI::KeyVisual>(),
...
const DependencyProperty KeyVisual::VisualTypeProperty = DependencyProperty::Register(
	...
	xaml_typename<IInspectable>(),
	xaml_typename<Magpie::UI::KeyVisual>(),
	PropertyMetadata(box_value(Magpie::UI::VisualType{}), &KeyVisual::_OnPropertyChanged)
);
...
void KeyVisual::VisualType(Magpie::UI::VisualType value) {
	SetValue(VisualTypeProperty, box_value(value));
}

Magpie::UI::VisualType KeyVisual::VisualType() const {
	return GetValue(VisualTypeProperty).as<Magpie::UI::VisualType>();
}
...
Style KeyVisual::_GetStyleSize(std::wstring_view styleName) const {
	...
	Magpie::UI::VisualType vt = VisualType();
