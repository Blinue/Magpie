...
conan install ..\conanfile.txt --install-folder ..\..\.conan\x64\Release --build=outdated -s build_type=Release -s arch=x86_64 -s compiler="Visual Studio" -s compiler.version=17 -s compiler.runtime=MD --update
