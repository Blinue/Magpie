...
void SettingsCard2::OnPointerPressed(PointerRoutedEventArgs const& args) {
	// 忽略鼠标右键
...
void SettingsCard2::OnPointerReleased(PointerRoutedEventArgs const& args) {
...
void SettingsCard2::_OnDescriptionChanged() const {
...
void SettingsCard2::_OnHeaderIconChanged() const {
...
void SettingsCard2::_OnActionIconChanged() const {
...
void SettingsCard2::_OnIsWrapEnabledChanged() const {
