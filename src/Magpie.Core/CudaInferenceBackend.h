...
class CudaInferenceBackend : public InferenceBackendBase {
public:
	CudaInferenceBackend() = default;
	CudaInferenceBackend(const CudaInferenceBackend&) = delete;
	CudaInferenceBackend(CudaInferenceBackend&&) = default;

	virtual ~CudaInferenceBackend();
