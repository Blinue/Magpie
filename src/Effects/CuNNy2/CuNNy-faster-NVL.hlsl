...
void Pass1(uint2 blockStart, uint3 tid) {
	...
	r0 = MulAdd(s0_0_0, V4(-3.649e-02, 6.494e-03, 6.929e-03, -1.320e-02), r0);
	r1 = MulAdd(s0_0_0, V4(-2.453e-01, 2.722e-02, -7.841e-02, -8.301e-01), r1);
	r0 = MulAdd(s0_0_1, V4(-5.663e-02, 2.213e-03, -9.981e-03, 7.036e-03), r0);
	r1 = MulAdd(s0_0_1, V4(-2.193e-01, 5.934e-04, -3.767e-02, -6.469e-02), r1);
	r0 = MulAdd(s0_0_2, V4(-5.772e-02, -7.180e-03, 4.832e-03, -4.077e-03), r0);
	r1 = MulAdd(s0_0_2, V4(3.104e-02, 3.213e-03, 8.831e-02, -1.925e-02), r1);
	r0 = MulAdd(s0_1_0, V4(-1.444e-01, 2.094e-03, -8.605e-01, -3.923e-02), r0);
	r1 = MulAdd(s0_1_0, V4(1.032e-01, 4.432e-02, 3.857e-01, 8.655e-01), r1);
	r0 = MulAdd(s0_1_1, V4(7.103e-01, 8.262e-01, 8.574e-01, 6.191e-01), r0);
	r1 = MulAdd(s0_1_1, V4(8.105e-01, -8.463e-02, -5.097e-01, 4.015e-02), r1);
	r0 = MulAdd(s0_1_2, V4(-8.078e-02, -1.313e-01, -2.669e-04, 3.881e-02), r0);
	r1 = MulAdd(s0_1_2, V4(-1.696e-01, -3.874e-02, 1.460e-01, 1.208e-02), r1);
	r0 = MulAdd(s0_2_0, V4(-5.270e-02, -9.660e-03, 3.139e-03, 5.236e-02), r0);
	r1 = MulAdd(s0_2_0, V4(8.130e-02, 2.059e-01, 1.882e-01, -3.923e-02), r1);
	r0 = MulAdd(s0_2_1, V4(-1.171e-01, -7.569e-01, 9.770e-04, -6.428e-02), r0);
	r1 = MulAdd(s0_2_1, V4(-2.483e-01, 3.656e-02, -2.046e-01, 3.488e-02), r1);
	r0 = MulAdd(s0_2_2, V4(1.227e-02, 6.710e-02, -5.071e-03, 3.497e-02), r0);
	r1 = MulAdd(s0_2_2, V4(-1.450e-01, 6.362e-02, 2.222e-02, -1.415e-03), r1);
	r0 = max(r0, 0.0);
	T0[gxy] = r0;
	r1 = max(r1, 0.0);
	T1[gxy] = r1;
