...
sys.stdout.reconfigure(encoding='utf-8', write_through=True, line_buffering=False)
sys.stderr.reconfigure(encoding='utf-8', write_through=True, line_buffering=False)
