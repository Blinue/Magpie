...
void Main(uint2 blockStart, uint3 threadId) {
	...
	float3	 c19 = INPUT.SampleLevel(sam, pos + float2(-3, 0) * inputPt, 0).rgb;
	float3	 c21 = float3(r10_4_1_21.w, g10_4_1_21.w, b10_4_1_21.w);
	float3	 c10 = float3(r10_4_1_21.x, g10_4_1_21.x, b10_4_1_21.x);
	float3	 c20 = INPUT.SampleLevel(sam, pos + float2(-2, 1) * inputPt, 0).rgb;
	float3	 c24 = INPUT.SampleLevel(sam, pos + float2(-1, -2) * inputPt, 0).rgb;
	...
	float3	 c22 = INPUT.SampleLevel(sam, pos + float2(0, -3) * inputPt, 0).rgb;
	...
	float3	 c13 = INPUT.SampleLevel(sam, pos + float2(0, 3) * inputPt, 0).rgb;
	...
	float3	 c14 = INPUT.SampleLevel(sam, pos + float2(1, 2) * inputPt, 0).rgb;
	float3	 c18 = INPUT.SampleLevel(sam, pos + float2(2, -1) * inputPt, 0).rgb;
	float3	 c11 = float3(r8_17_11_5.z, g8_17_11_5.z, b8_17_11_5.z);
	float3	 c17 = float3(r8_17_11_5.y, g8_17_11_5.y, b8_17_11_5.y);
	float3	 c16 = INPUT.SampleLevel(sam, pos + float2(3, 0) * inputPt, 0).rgb;
